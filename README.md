...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/rghero09)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/rghero09
```

A live public deployment of this template is available at [https://rghero09.templates.workers.dev](https://rghero09.templates.workers.dev)
